...
export const dict = {
  zh: {
    ...
    "configView.prepare": "AI 准备",
    "configView.form": "表单",
    "configView.json": "配置 · JSON",
    "configOutline.workspace": "工作区",
    "configOutline.formGroups": "表单分区",
    "sourceBar.authority": "权威",
    "sourceBar.localDraft": "本地草稿",
    "sourceBar.db": "数据库",
    "sourceBar.obs": "OBS",
    "sourceBar.obsState": "live-state · 当前状态",
    "sourceBar.obsHint": "OBS 源单向镜像当前状态（不可在此反向编辑）。",
    ...
    "agentPrepare.title": "AI 准备",
    "agentPrepare.intro": "让 AI Agent 准备本场配置，然后 导入 → 检查 → 应用。",
    "agentPrepare.handoffTitle": "Agent 交接",
    "agentPrepare.handoffBody": "复制现成提示词（v1 schema + 当前配置）。在你的 AI 工具里运行，得到更新后的 live-session.config.json。",
    "agentPrepare.briefLabel": "简述（可选）",
    "agentPrepare.briefPlaceholder": "用一句话描述本场直播…",
    "agentPrepare.copyPrompt": "复制 Agent 提示词",
    "agentPrepare.copied": "已复制提示词 — 在 AI 工具里运行，再导入 JSON。",
    "agentPrepare.copyFailed": "复制失败，请手动选择提示词文本。",
    "agentPrepare.nextTitle": "下一步",
    "agentPrepare.nextBody": "把返回的 JSON 粘到 配置 · JSON → 校验 → 应用。导入不会自动应用，需先检查。",
    "agentPrepare.openJson": "打开 配置 · JSON",
    "agentPrepare.promptTitle": "提示词预览",
    "config.discard": "丢弃更改",
  ...
  en: {
    ...
    "configView.prepare": "AI Prepare",
    "configView.form": "Form",
    "configView.json": "Config · JSON",
    "configOutline.workspace": "Workspace",
    "configOutline.formGroups": "Form",
    "sourceBar.authority": "Authority",
    "sourceBar.localDraft": "Local draft",
    "sourceBar.db": "DB",
    "sourceBar.obs": "OBS",
    "sourceBar.obsState": "live-state · current state",
    "sourceBar.obsHint": "OBS sources mirror the current state (one-way push). Not editable here.",
    ...
    "agentPrepare.title": "AI Prepare",
    "agentPrepare.intro": "Have an AI agent prepare this stream's config, then Import → review → Apply.",
    "agentPrepare.handoffTitle": "Agent handoff",
    "agentPrepare.handoffBody": "Copy a ready prompt (the v1 schema + the current config). Run it in your AI tool to get an updated live-session.config.json.",
    "agentPrepare.briefLabel": "Brief (optional)",
    "agentPrepare.briefPlaceholder": "Describe this stream in plain language…",
    "agentPrepare.copyPrompt": "Copy agent prompt",
    "agentPrepare.copied": "Prompt copied — run it in your AI tool, then import the JSON.",
    "agentPrepare.copyFailed": "Could not copy. Select the prompt text manually.",
    "agentPrepare.nextTitle": "Next",
    "agentPrepare.nextBody": "Paste the returned JSON in Config · JSON → Validate → Apply. Import never auto-applies; you review first.",
    "agentPrepare.openJson": "Open Config · JSON",
    "agentPrepare.promptTitle": "Prompt preview",
