...
export const dict = {
  zh: {
    ...
    "settingsGroup.assetsHint": "品牌资产 — 在 Cover / Poster 面板编辑,这里给摘要。",
    ...
    "settingsRow.sessionInspectorNote": "标题、副标题、作者在 Cover / Poster 面板编辑;它们是核心,出现在 JSON 里。",
    "settingsRow.onAirDesc": "开场时间 — 运行时,不在配置文件内。",
    "settingsRow.assetsInspectorNote": "社交、徽标、头像在 Cover / Poster 面板编辑;这里是只读摘要,可跳到 JSON。",
    ...
    "manualSettings.searchPlaceholder": "搜索分类…",
    "manualSettings.searchHelp": "按设置分组过滤,不含单个字段。",
    "manualSettings.matches": "个分类匹配",
    "manualSettings.noMatches": "没有匹配的设置分类。",
    "manualSettings.openJsonAt": "在 JSON 中打开",
    "agent.title": "Agent",
    "agent.intro": "用 Agent 准备本场直播配置,结果需人工 review 后再 Apply。",
    "agent.youLabel": "你",
  ...
  en: {
    ...
    "settingsGroup.assets": "Socials / Badges / Profile",
    "settingsGroup.assetsHint": "Brand assets — edited in the Cover / Poster inspector; summarized here.",
    "settingsGroup.advanced": "Advanced / JSON",
    ...
    "settingsRow.sessionInspectorNote": "Title, subtitle and author are edited in the Cover / Poster inspector; they are core and appear in the JSON.",
    "settingsRow.onAirDesc": "On-air start time — runtime, not in the config file.",
    "settingsRow.assetsInspectorNote": "Socials, badges and avatar are edited in the Cover / Poster inspector; this is a read-only summary with a jump to the JSON.",
    ...
    "manualSettings.searchPlaceholder": "Search categories…",
    "manualSettings.searchHelp": "Filters setting groups, not individual fields.",
    "manualSettings.matches": "categories match",
    "manualSettings.noMatches": "No settings categories match.",
    "manualSettings.openJsonAt": "Open in JSON",
    "agent.title": "Agent",
    "agent.intro": "Use an agent to prepare this stream's config. Results are reviewed before Apply.",
    "agent.youLabel": "You",
